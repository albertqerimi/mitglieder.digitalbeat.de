...
class ncore_FormRenderer_InputCheckboxListSelect extends ncore_FormRenderer_InputBase
{
    ...
    protected function renderInnerWritable()
    {
        ...
        return ncore_htmlCheckboxListShort($postname, $options, $selected_values, $attributes );
    }
