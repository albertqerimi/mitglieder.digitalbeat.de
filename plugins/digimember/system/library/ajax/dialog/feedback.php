...
class ncore_Ajax_DialogFeedback extends ncore_Ajax_DialogBase
{
    ...
    protected function renderSkipLink( )
    {
        $skipLabel = $this->meta('label_skip', _ncore('Deactivate without Feedback'));
        return '<a href="#" onclick="dmFeedback.skip();" class="dm-dialog-feedback-skip-link">'.$skipLabel.'</a>';
    }
...
\n";
    ...
    function form()
    {
        ...
        $settings[ 'layout' ] = 'table_feedback';
