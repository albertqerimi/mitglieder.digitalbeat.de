...
class Folder extends Controller {
	...
	public function enqueueAdminScripts( $screenId ) {
		...
		wp_enqueue_script( 'fbv-folder', NJFB_PLUGIN_URL . 'assets/dist/js/app.js', array( 'wp-hooks' ), NJFB_VERSION, false );
	...
	public function postsClauses( $clauses, $query ) {
		...
		$fbvOrder    = $query->get( 'orderby' ) === $sizeMeta;
