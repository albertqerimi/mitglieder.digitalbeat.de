...
function re_render_modules()
{
    ...
    lb_data.forEach(function(lesson)
    {
        ...
        <div class="mgb_sublesson_duration"><span class="mgb_sublesson_date">` + lesson['sublesson_aufzeichnungsdatum'] + `</span><strong>Dauer: </strong>` + lesson['sublesson_video_lange'] + `</div>
    ...
    jQuery('.mgb_sublesson_tile_wrapper').html(modules_html);
}